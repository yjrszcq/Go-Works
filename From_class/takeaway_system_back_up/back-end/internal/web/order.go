...
func (o *OrderHandler) CreateOrder(ctx *gin.Context) {
	...
	if err := ctx.ShouldBindJSON(&req); err != nil {
		ctx.JSON(http.StatusOK, gin.H{"message": "创建失败, 系统错误"})
		return
	}
...
func (o *OrderHandler) PayTheOrder(ctx *gin.Context) {
	...
	var req UpdateReq
	if err := ctx.ShouldBindJSON(&req); err != nil {
		ctx.JSON(http.StatusOK, gin.H{"message": "支付失败, 系统错误"})
		return
	}
...
func (o *OrderHandler) ConfirmTheOrder(ctx *gin.Context) {
	...
	var req UpdateReq
	if err := ctx.ShouldBindJSON(&req); err != nil {
		ctx.JSON(http.StatusOK, gin.H{"message": "更新失败, 系统错误"})
		return
	}
...
func (o *OrderHandler) CancelTheOrder(ctx *gin.Context) {
	...
	var req UpdateReq
	if err := ctx.ShouldBindJSON(&req); err != nil {
		ctx.JSON(http.StatusOK, gin.H{"message": "取消失败, 系统错误"})
		return
	}
